...
const socialLinks = [
  { icon: LinkedinIcon, href: 'https://www.linkedin.com/company/agritradeoverseas', label: 'LinkedIn' },
  { icon: FacebookIcon, href: 'https://www.facebook.com/share/1DgYx7DfEw/', label: 'Facebook' },
  { icon: InstagramIcon, href: 'https://www.instagram.com/agritradeoverseas', label: 'Instagram' },
];
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-sm">agritradeoverseas07@gmail.com</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm">+91 93286 33775</span>
              </a>
            </div>
          </div>
        </div>
