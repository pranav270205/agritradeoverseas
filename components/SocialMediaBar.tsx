...
const socialLinks = [
  { icon: FacebookIcon, href: 'https://www.facebook.com/share/1DgYx7DfEw/', label: 'Facebook', color: 'hover:bg-blue-600' },
  { icon: InstagramIcon, href: 'https://www.instagram.com/agritradeoverseas', label: 'Instagram', color: 'hover:bg-pink-600' },
  { icon: LinkedinIcon, href: 'https://www.linkedin.com/company/agritradeoverseas', label: 'LinkedIn', color: 'hover:bg-blue-700' },
];
    ...
    <section className="py-6 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Brochure Download */}
          <a
            href="/brochure/AGRITRADEOVERSEAS_BROCHURE.pdf"
            download="AGRITRADEOVERSEAS_BROCHURE.pdf"
            className="flex items-center gap-4 group"
            onClick={(e) => {
              fetch('/brochure/AGRITRADEOVERSEAS_BROCHURE.pdf', { method: 'HEAD' })
                .then((res) => {
                  if (!res.ok) {
                    e.preventDefault();
                    alert('Sorry, the brochure is currently unavailable. Please try again later or contact us for a copy.');
                  }
                })
                .catch(() => {
                  e.preventDefault();
                  alert('Sorry, the brochure could not be downloaded. Please check your internet connection and try again.');
                });
            }}
          >
